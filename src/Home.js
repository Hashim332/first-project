    ...
    <div>
      ...
      <div className="m-8">
        <a
          ...
          download
          className="p-3 bg-secondary-900 hover:bg-red-900  text-white shadow-xl rounded-md font-red-hat"
        >
          <button className="w-1/12">📎 My CV</button>
        </a>
      </div>
